  ...
  return (
    <div className="flex flex-col h-full bg-background">
      ...
      <div className="flex items-center justify-between px-3 pt-3 pb-2">
        <Badge variant="default" className="text-[11px] tracking-widest uppercase rounded-sm">
          Activity
        </Badge>
        {logs.length > 0 && (
      ...
      <div className="flex-1 mx-2 mb-2 rounded-lg border border-border bg-card overflow-y-auto">
        {logs.length === 0 ? (
          <p className="text-[11px] text-muted-foreground text-center mt-6 px-2 leading-relaxed">
            Run the pipeline to see activity here.
          </p>
        ) : (
          <div className="p-2 font-mono text-[11px] leading-[1.85] space-y-px">
            {logs.map((line, i) => {
